  ...
  .then(data => {
    ...
    if (Array.isArray(data)) {
      ...
      data.forEach((entry, index) => {
        ...
        // displayContent += `<p><strong>ID:</strong> ${entry.id}</p>`;
        ...
        // displayContent += `<button class="upvote-btn" data-id="${index}">Upvote</button>`;
        ...
        // displayContent += `<p><strong>URL:</strong> <a href="${entry.url}" 
        // target="_blank">${entry.url}</a></p>`;
